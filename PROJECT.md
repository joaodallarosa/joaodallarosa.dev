...
**Not yet done:** applying the vertical-rail shell change to the reading pages' visual QA (post/log entry templates weren't touched, should still render fine under the new rail but haven't been screenshotted), and rolling any further "shell bold" treatment beyond the homepage if Joao wants it.
