...
_Last updated: 2026-07-08 (Phase 5 homepage flow-field background shipped) · This file is the running source of truth for context, decisions, and "why." Hand this to a fresh Claude session before starting new work so it doesn't need to be re-explained._
